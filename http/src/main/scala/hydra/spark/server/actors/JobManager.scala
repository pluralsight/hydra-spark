...
//    val jobDAO = new SlickJobRepository()
//    val binaryRootFolder = config.get[String]("spark.server.binary.root.dir")
//      .valueOrElse("/tmp/hydra-spark/binaries")
//    val binaryRepository = new SlickBinaryRepository(binaryRootFolder)
//    val jobConfigRepository = new SlickJobConfigRepository()
//    val daoActor = system.actorOf(Props(classOf[JobRepositoryActor],
//      jobDAO, binaryRepository, jobConfigRepository), "dao-manager-jobmanager")
//
