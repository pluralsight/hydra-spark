...
/**
  ...
  * }}}
  */
abstract class JobManagerActor(contextConfig: Config, daoActor: ActorRef) extends Actor with ActorLogging {
...
//        log.info("Got Spark Application end event, stopping job manager.")
//        self ! PoisonPill
//      }
//    }
//  }
...
//      } catch {
//        case t: Throwable =>
//          log.error("Failed to create context " + contextName + ", shutting down actor", t)
//          sender ! InitError(t)
//          self ! PoisonPill
//      }
//
...
//          log.info("Adding {} to Current Job Class path", jarUri)
//          jarLoader.addURL(new URL(convertJarUriSparkToJava(jarUri)))
...
//        } catch {
//          case e: Exception => {
//            log.error("SparkContext does not exist!")
//            sender ! SparkContextDead
//          }
//        }
//      }
